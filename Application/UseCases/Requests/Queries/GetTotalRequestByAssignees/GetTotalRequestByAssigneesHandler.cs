...
{
    public sealed class GetTotalRequestByAssigneesHandler
         : IQueryHandler
        <GetTotalRequestByAssigneesQueries, CountRequestPage>
    {
        private readonly IUnitOfWorkRepository _repo;
        private readonly IMapper _mapper;

        public GetTotalRequestByAssigneesHandler(IUnitOfWorkRepository repo, IMapper mapper)
        {
            _repo = repo;
            _mapper = mapper;
        }
        ...
        public async Task<Result<CountRequestPage>> Handle(
            GetTotalRequestByAssigneesQueries request,
