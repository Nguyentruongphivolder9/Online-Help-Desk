...
{
    public sealed class GetTotalRequestHandler : IQueryHandler
        <GetTotalRequestQueries, CountRequestPage>
    {
        ...
        public async Task<Result<CountRequestPage>> Handle(GetTotalRequestQueries request, CancellationToken cancellationToken)
        {
